...
function Start () {
	...
	singleWave.spawnSingle(bossZombiePrefab, 28, Edge.LEFT);


	singleWave.spawnContinuous(normalZombiePrefab, 3, 10, 5, Edge.RIGHT);
	singleWave.spawnContinuous(normalZombiePrefab, 3, 10, 5, Edge.LEFT);
	...
	singleWave.spawnContinuous(normalZombiePrefab, 13, 10, 5, Edge.LEFT);
